 ...
 *
 * ⚠ **`なし` ＝ 海のもの、ではない**（2026-09-07 訂正）。実データでは
 *   `なし` 77品のうち**70品は加工品**であり、海のものではない。
...
export type SuitedLand =
   ...
   *   Phase 1 が取り下げた面「保存」（時間経過で劣化する仕組み）とは別物。
   *   2026-09-07 に一度「例示『生鮮』には定義文からの根拠が無い」として
   *   削除しかけたが、**根拠が無かったのは定義文の側**だったので、定義文に書き足して揃えた。
   */
  | '温暖な土地'
  /**
