 ...
 * 各段の費用。**段が進むほど高い。**
 *
 * ⚠ **総額 2,236,000 は目標額 2,000,000 を超えている。これは方針どおりで、下げない**
 *   （`what-players-should-do.md` 方針4「**目標到達時点で最大拡張・レシピ全開放でなくてよい。
 *   買い残し・作り残しがあるのが正常**」）。
 *   **全部買えてしまうと「いま買うか、目標まで我慢するか」という上の問いが消える。**
 *
 * ⚠ **以前ここに「未調整。比が100%を超えると誰も買わない」と書いてあったのは誤り**
 *   （2026-09-15 に直した）。**目標額も1000万ではなく 2,000,000。**
 *   測る道具では、どの遊び方も**改装を買いながら**目標に届いている。
 */
